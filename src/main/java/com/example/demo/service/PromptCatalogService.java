...
public class PromptCatalogService {
    ...
    private final Map<String, Object> defaults; // ✨ ai.defaults
    ...
    public PromptCatalogService(
        ...
        this.defaults = props.getDefaults() == null ? Map.of() : props.getDefaults();
    ...
    private Resource resolve(String key) {
        ...
        if (sections != null && sections.containsKey(key)) {
            res = resourceLoader.getResource(sections.get(key).getPrompt());
        } else if (prompts != null && prompts.containsKey(key)) {
